...
$stm = $db->prepare("INSERT INTO helpdesk(issue_id, fname, dep, subject, create_time, status, error_type) VALUES ('$helpID', '$fname', '$dep', '$subject', '$currentTimestamp', 'send', '$error')");
if ($stm->execute()) {
